...
class OutputLSTMLayer(nn.Module):
    def __init__(self, in_channels, out_channels,dp=0.1):
        ...
        self.lstm = nn.LSTM((in_channels), (128+out_channels), batch_first=True, bidirectional=True, proj_size=out_channels)
...
class Model(nn.Module):
    def __init__(
        ...
        self.config = [params_channels, wav2vec_path, lstm_stack, dp, out_norm, debug]
