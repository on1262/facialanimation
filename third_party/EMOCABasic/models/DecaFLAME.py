...
from decautils.lbs import lbs, batch_rodrigues, vertices2landmarks
...
class FLAME(nn.Module):
    ...
    def __init__(self):
        ...
        self.register_buffer('dynamic_lmk_faces_idx',
                             lmk_embeddings['dynamic_lmk_faces_idx'].clone().detach())
        self.register_buffer('dynamic_lmk_bary_coords',
                             lmk_embeddings['dynamic_lmk_bary_coords'].clone().detach())
